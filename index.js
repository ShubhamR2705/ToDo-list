const inputFeild = document.querySelector(".input input");
const addBtn = document.querySelector(".input button");
const List = document.querySelector(".list");
const clearBtn = document.querySelector(".bottom button")

inputFeild.onkeyup = () => {
    let userData = inputFeild.value;
...
function showTask() {
    ...
    pending.innerHTML = todoArr.length;
